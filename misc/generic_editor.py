...
from .repeat import set_again, againKey
from ..utils import (
    parse_words,
    join_words,
    numeral_list,
...
ctx.keymap(
    {
        ...
        # "(undo | dizzle | ups)": [Key("cmd-z"), set_again("cmd-z", "cmd-shift-z")],
        # "(redo | rizzle)": [Key("cmd-shift-z"), set_again("cmd-shift-z", "cmd-z")],
        "(undo | dizzle | ups)": Key("cmd-z"),
        "(redo | rizzle)": Key("cmd-shift-z"),
        # clipboard
        "(snatch)": Key("cmd-x"),
        "(stoosh)": Key("cmd-c"),
        "(spark)": Key("cmd-v"),
        "(paste preserve formatting | match spark)": Key("cmd-shift-alt-v"),
        # motions
